...
# [-] (See branch feature/accumulate_overlaps but decided against it) Turn on/off accumulating overlapping ranges (if ranges overlap, count IDs within them as fresh multiple times)
